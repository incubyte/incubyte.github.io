...
Over the years, the software development process has seen a massive change of pace. Specially to build complex systems, the ideation and design, all through its development and implementation involves multiple teams. These groups have various responsibilities and need to work in a cohesive manner to achieve the end goal.


Bogged down by Waterfall:

Traditional development methodologies with their linear processes just don’t cut it these days, what with the frequency of clients’ demands, and needing to use intricate tools and technologies. To get to the point of getting a deliverable ready looks more like the diagram below with multiple points of communication rather than a straight line.
...
How communication happens in the real world, with multiple teams involved.
...
·	Treating QA testing as an afterthought
·	Lack of process automation and slower release cycles 
